*+--------------------------------------------------------------------
*+
*+ Source Module => c:\hmg.3.4.4\SOURCE\\h_HMG_HPDF_UNICODE.prg
*+
*+    Copyright(C) 1983-2020 by Auge & Ohr
*+
*+    Functions: Function _HMG_HPDF_MULTILINE_PRINT_UNICODE()
*+               Function _HMG_HPDF_DRAWIMAGERAW()
*+
...
*+--------------------------------------------------------------------
*+
*+    Function _HMG_HPDF_MULTILINE_PRINT_UNICODE()
*+
*+--------------------------------------------------------------------
*+
...
*+    Function _HMG_HPDF_DRAWIMAGERAW()
*+
*+    Called from ( h_hmg_hpdf_unicode.prg )   1 - function _hmg_hpdf_multiline_print_unicode()
*+
*+--------------------------------------------------------------------
*+
...
// SetBkColor (hDC, RGB (255,255,255));
   ...
   DrawText (hDC, cText, -1, &rect, DT_NOCLIP | DT_WORDBREAK | DT_NOPREFIX | nAlign);
}
